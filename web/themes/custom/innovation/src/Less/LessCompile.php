...
use Drupal\innovation\Less\LesscFormatterCompressed;
use Drupal\innovation\Less\LesscFormatterLessjs;
/**
 * lessphp v0.4.0
...
class LessCompile {
	...
	protected function newFormatter() {
		$className = "Drupal\innovation\Less\LesscFormatterLessjs";
		if (!empty($this->formatterName)) {
			if (!is_string($this->formatterName))
				return $this->formatterName;
			$className = "Drupal\innovation\Less\LesscFormatter$this->formatterName";
		}
