...
class IconSelectForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $icons = \Drupal::service('inv_builder.fonticon')->getIcons();
    $form['#attached']['library'] = \Drupal::service('inv_builder.fonticon')->getLibraries();
    $form['library'] = array(
      '#type' => 'select',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $command = new CloseBuilderModalDialogCommand('#inv-builder-icon-select');
