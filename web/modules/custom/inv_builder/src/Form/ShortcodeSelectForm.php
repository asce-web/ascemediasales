...
class ShortcodeSelectForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($shortcode_plugins as $shortcode_id => $s) {
	  ...
	  if(($shortcode instanceof \Drupal\inv_builder\Plugin\Shortcode\BuilderElement) == false){
        continue;
      }
      ...
      $el = array(
        ...
        '#url' => Url::fromRoute('inv_builder.shortcode_settings', array('shortcode_id' => $shortcode_id, 'action' => 'add')),
        '#attributes' => ['class' => ['inv-builder-modal']],
  ...
  public function getFormId() {
    return 'inv_builder_shortcode_select';
  }
