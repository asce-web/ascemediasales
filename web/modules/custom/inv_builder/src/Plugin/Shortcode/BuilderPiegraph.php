...
class BuilderPiegraph extends BuilderElement {
    ...
    public function process(array $attributes, $text, $langcode = Language::LANGCODE_NOT_SPECIFIED) {
        ...
        $piegraph_id = \Drupal\Component\Utility\Html::getUniqueId('inv_builder_piegraph_' . REQUEST_TIME);
        $header_style='';
        $icon_style='';
        ...
        $heading = '<' . $attributes['heading_size'] . ' class="inv-pie-chart-title" style="'.$header_style.'">' . $attributes['title'] . '</' . $attributes['heading_size'] . '>';
        $icon='<i style="'.$icon_style.'"></i>';
        $return = array(
            '#theme' => 'inv_builder_piegraph',
            ...
            '#content' => $text,
            '#attached' => ['library' => 'inv_builder/piegraph'],
        );
