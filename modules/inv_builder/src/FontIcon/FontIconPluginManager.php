...
namespace Drupal\inv_builder\FontIcon;
...
class FontIconPluginManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/FontIcon', $namespaces, $module_handler, 'Drupal\inv_builder\Plugin\FontIconInterface', 'Drupal\inv_builder\Annotation\FontIcon');
