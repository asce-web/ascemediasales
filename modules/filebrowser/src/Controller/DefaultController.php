...
class DefaultController extends ControllerBase {
  ...
  public function pageDownload($fid) {
    ...
    // Download method is 'public' and the file location is local
    // we will send the browser to the file location.
    if ($filebrowser->downloadManager == 'public' && $this->common->isLocal($file_data->uri)) {
      // public (direct) downloads. We can also use this for private:// because drupal will handle the url properly
